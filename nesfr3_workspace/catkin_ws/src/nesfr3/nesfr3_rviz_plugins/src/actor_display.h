#ifndef ACTOR_DISPLAY_H
#define ACTOR_DISPLAY_H
...
// rviz::Display.
class ActorDisplay: public rviz::MessageFilterDisplay<nesfr3_msgs::Actor>
{
Q_OBJECT
public:
...
private:
  void processMessage( const nesfr3_msgs::Actor::ConstPtr& msg );
