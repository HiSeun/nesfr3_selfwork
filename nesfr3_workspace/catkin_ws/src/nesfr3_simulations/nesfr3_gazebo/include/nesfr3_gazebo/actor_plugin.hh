...
namespace gazebo
{
  class GZ_PLUGIN_VISIBLE ActorPlugin : public ModelPlugin
  {
    ...
    private: inline void ExtractData(auto *msg_point, std::string name);
    ...
    private: physics::ModelPtr face_plane;
    ...
    private: ros::Publisher msg_pub;

    private: uint32_t id; 

    private: bool fixed_angle;

    private: bool fixed_direction;

    private: common::Time fixed_direction_time;

    private: double desirable_yaw;

    private: uint32_t robots_to_ignore;
  };
}
#endif
