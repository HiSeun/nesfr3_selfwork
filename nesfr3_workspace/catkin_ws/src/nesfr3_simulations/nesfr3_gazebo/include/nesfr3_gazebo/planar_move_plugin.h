...
namespace gazebo {
    class GazeboRosForceBasedMove : public ModelPlugin {
        public: 
            ...
            void inline RemoveDuplicateSlashes(std::string &name); //maybe put it in a separate "utils" cpp
        ...
        private:
            ...
            tf::Transform getTransformForMotion(double linear_vel_x, double linear_vel_y,
        ...
        private: std::string link_name_;
                 ...
                 // Command acceleration callback
                 void cmdAccCallback(const geometry_msgs::Twist::ConstPtr& cmd_msg);
