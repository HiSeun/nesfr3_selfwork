...
echo_and_run cd "/mnt/catkin_ws/src/nesfr3/nesfr3_rqt_plugins/shot_controller_rqt"
...
echo_and_run /usr/bin/env \
    ...
    "/mnt/catkin_ws/src/nesfr3/nesfr3_rqt_plugins/shot_controller_rqt/setup.py" \
     \
    build --build-base "/mnt/catkin_ws/build/nesfr3/nesfr3_rqt_plugins/shot_controller_rqt" \
    install \
    --root="${DESTDIR-/}" \
