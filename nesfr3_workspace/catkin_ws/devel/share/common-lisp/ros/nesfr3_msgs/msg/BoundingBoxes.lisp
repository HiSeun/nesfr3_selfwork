...
(cl:defmethod cl:initialize-instance :after ((m <BoundingBoxes>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BoundingBoxes)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nesfr3_msgs-msg:<BoundingBoxes> is deprecated: use nesfr3_msgs-msg:BoundingBoxes instead.")))
...
(cl:defmethod image_header-val ((m <BoundingBoxes>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nesfr3_msgs-msg:image_header-val is deprecated.  Use nesfr3_msgs-msg:image_header instead.")
  (image_header m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<BoundingBoxes>)))
  ...
  "4bd0b54eccdf9543d1d6a416ce70f1b5")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'BoundingBoxes)))
  "Returns md5sum for a message object of type 'BoundingBoxes"
  "4bd0b54eccdf9543d1d6a416ce70f1b5")
