...
"""autogenerated by genpy from nesfr3_msgs/PoseArrayWithClusters.msg. Do not edit."""
import codecs
import sys
...
class PoseArrayWithClusters(genpy.Message):
  _md5sum = "bbc8c4c94ff268f3408af56ee11c7b83"
  _type = "nesfr3_msgs/PoseArrayWithClusters"
...
"""
  __slots__ = ['header','poses','segments']
  _slot_types = ['std_msgs/Header','geometry_msgs/Pose[]','sensor_msgs/PointCloud2[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PoseArrayWithClusters, self).__init__(*args, **kwds)
